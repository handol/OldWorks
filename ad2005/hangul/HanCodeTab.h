#ifndef HANCODE_TAB_H
#define HANCODE_TAB_H

#ifdef HANCHAR_H
#define	CLASSNAME	HanChar
#endif

#ifdef WANSUNG_H
#define	CLASSNAME	Wansung
#endif

#ifdef JASO_ROMANCODE
/**
chosung, jungsung, lastsnd 은 조합형 자소를 출력하기 좋게 alphabet 로 mapping  한 것.
KLDP 에서 구한 것임.
*/
char CLASSNAME::FstSndEng[32][3]={
	"","", "g","kk","n","d","tt","r","m","b","pp","s","ss",
	"","j","jj","ch","k","t","p","h"
	,"","","","","","","","","","",""};

char CLASSNAME::MidSndEng[32][4]={
	"","","","a","ae","ya","yae","eo",
	"","","e","yeo","ye","o","wa","wae",
	"","","oe","yo","u","woe","we","wi",
	"","","you","eu","ui","i","",""};

char CLASSNAME::LastSndEng[32][3]={
	"","","g","kk","k","n","n","n","t","l",
	"lg","lm","lb","ls","lt","lp","lh",
	"m","","b","bs","s","ss","ng","j","ch",
	"k","t","p","h","",""};

#endif

#ifdef SIMPLE_JASOINFO
char CLASSNAME::HanFirstSound[32][3]= {
	"", "", "ㄱ", "ㄲ", "ㄴ", "ㄷ", "ㄸ", "ㄹ", "ㅁ", 
	"ㅂ", "ㅃ", "ㅅ", "ㅆ", "", "ㅈ", "ㅉ", "ㅊ", "ㅋ", "ㅌ", "ㅍ", "ㅎ",
	"","","","","","","","","","",""};

char CLASSNAME::HanMiddleSound[32][3]= {
	"","","", "ㅏ", "ㅐ", "ㅑ", "ㅒ", "ㅓ", 
	"", "", "ㅔ", "ㅕ", "ㅖ", "ㅗ", "ㅘ", "ㅙ", 
	"", "", "ㅚ", "ㅛ","ㅜ", "ㅝ", "ㅞ", "ㅟ", 
	"", "", "ㅠ", "ㅡ", "ㅢ", "ㅣ",
...
char CLASSNAME::HanLastSound[32][3]= {
	"", "", "ㄱ", "ㄲ", "ㄳ", "ㄴ", "ㄵ", "ㄶ", "ㄷ", "ㄹ", 
	"ㄺ", "ㄻ", "ㄼ", "ㄽ", "ㄾ", "ㄿ", "ㅀ",
	"ㅁ", "", "ㅂ", "ㅄ", "ㅅ", "ㅆ", "ㅇ", "ㅈ", "ㅊ",
	"ㅋ", "ㅌ", "ㅍ", "ㅎ", "", ""
...
/**
HFstSnd, HMidSnd, HLastSnd 은 조합형 자소의 초성, 중성, 종성 값에 
mapping 되는 완성형 자모 글자.
*/
firstJasoInfo CLASSNAME::HFstSnd[32] = {
	/* 문자열, 원본 자소, 된소리 자소, 거센소리 자소, 성질 */
	/* 0 */ { "\0",   0,   0,   0 ,  S_NONE}, 
	/* 1 */ { "\0",   0,   0,   0 ,  S_NONE}, 
	/* 2 */ { "ㄱ",   2,   3,   17,  S_NONE }, 
	/* 3 */ { "ㄲ",   2,   3,   17,  S_DOUBLE }, 
	/* 4 */ { "ㄴ",   4,   4,   4,  S_NONE | S_VOICE}, 
	/* 5 */ { "ㄷ",   5,   6,   18,  S_NONE }, 
	/* 6 */ { "ㄸ",   5,   6,   18,  S_DOUBLE }, 
	/* 7 */ { "ㄹ",   7,   7,   7,  S_NONE| S_VOICE }, 
	/* 8 */ { "ㅁ",   8,   8,   8,  S_NONE | S_VOICE}, 
	/* 9 */ { "ㅂ",   9,   10,   19,  S_NONE }, 
	/* 10 */ { "ㅃ",  9,  10,  19,  S_DOUBLE }, 
	/* 11 */ { "ㅅ",  11,  12,  11,  S_NONE }, 
	/* 12 */ { "ㅆ",  11,  12,  12,  S_DOUBLE }, 
	/* 13 */ { "ㅇ",   13,   0,   0 ,  S_NONE }, 
	/* 14 */ { "ㅈ",  14,  15,  16,  S_NONE }, 
	/* 15 */ { "ㅉ",  14,  15,  16,  S_DOUBLE }, 
	/* 16 */ { "ㅊ",  14,  16,  16,  S_HARSH }, 
	/* 17 */ { "ㅋ",  2,  3,  17,  S_HARSH }, 
	/* 18 */ { "ㅌ",  5,  6,  18,  S_HARSH }, 
	/* 19 */ { "ㅍ",  9,  10,  19,  S_HARSH }, 
	/* 20 */ { "ㅎ",  20,  20,  20,  S_NONE }, 
	/* 21 */ { "\0",   0,   0,   0 ,  S_NONE}, 
	/* 22 */ { "\0",   0,   0,   0 ,  S_NONE}, 
	/* 23 */ { "\0",   0,   0,   0 ,  S_NONE}, 
	/* 24 */ { "\0",   0,   0,   0 ,  S_NONE}, 
...
secondJasoInfo CLASSNAME::HMidSnd[32] = {
	/*
	단모음 10개(ㅏ,ㅓ,ㅗ,ㅜ,ㅡ,ㅣ,ㅔ,ㅐ,ㅚ,ㅟ)
	이중모음 11개(ㅑ,ㅕ,ㅛ,ㅠ,ㅖ,ㅒ,ㅘ,ㅙ,ㅝ,ㅞ,ㅢ)
	...
	*/
	...
	/* 1 */ { "\0",   0,   0,   0 ,  S_NONE}, 
	/* 2 */ { "\0",   0,   0,   0 ,  S_NONE}, 
	/* 3 */ { "ㅏ",   3,   3,   0,  S_POSITIVE }, 
	/* 4 */ { "ㅐ",   3,   11,   0,  S_POSITIVE }, 
	/* 5 */ { "ㅑ",   29,  3,   0,  S_POSITIVE | S_DOUBLE }, 
	/* 6 */ { "ㅒ",   4,   29,   0,  S_POSITIVE | S_DOUBLE}, 
	/* 7 */ { "ㅓ",   7,   0,   0,  S_NONE }, 
	/* 8 */ { "\0",   0,   0,   0 ,  S_NONE}, 
	/* 9 */ { "\0",   0,   0,   0 ,  S_NONE}, 
	/* 10 */ { "ㅔ",  10,  0,  0,  S_NONE }, 
	/* 11 */ { "ㅕ",  29,  7,  0,  S_NONE | S_DOUBLE}, 
	/* 12 */ { "ㅖ",  11,  29,  0,  S_NONE | S_DOUBLE}, 
	/* 13 */ { "ㅗ",  13,  0,  0,  S_POSITIVE }, 
	/* 14 */ { "ㅘ",  13,  3,  0,  S_POSITIVE | S_DOUBLE}, 
	/* 15 */ { "ㅙ",  18,  7,  0,  S_NONE | S_DOUBLE}, 
	/* 16 */ { "\0",   0,   0,   0 ,  S_NONE}, 
	/* 17 */ { "\0",   0,   0,   0 ,  S_NONE}, 
	/* 18 */ { "ㅚ",  13,  29,  0,  S_POSITIVE },  // 요즘은 단모음으로 간주하나 창제 원리에 맞게 표현하고자.
	/* 19 */ { "ㅛ",  13,  0,  0,  S_POSITIVE| S_DOUBLE }, 
	/* 20 */ { "ㅜ",  20,  0,  0,  S_NONE }, 
	/* 21 */ { "ㅝ",  20,  7,  0,  S_NONE | S_DOUBLE}, 
	/* 22 */ { "ㅞ",  20,  10,  0,  S_NONE | S_DOUBLE}, 
	/* 23 */ { "ㅟ",  20,  29,  0,  S_NONE }, 
	/* 24 */ { "\0",   0,   0,   0 ,  S_NONE}, 
	/* 25 */ { "\0",   0,   0,   0 ,  S_NONE}, 
	/* 26 */ { "ㅠ",  20,  0,  0,  S_NONE | S_DOUBLE}, 
	/* 27 */ { "ㅡ",  27,  0,  0,  S_NONE }, 
	/* 28 */ { "ㅢ",  27,  29,  0,  S_NONE | S_DOUBLE}, 
	/* 29 */ { "ㅣ",  29,  0,  0,  S_NONE }, 
	/* 30 */ { "\0",   0,   0,   0 ,  S_NONE}, 
	/* 31 */ { "\0",   0,   0,   0 ,  S_NONE}
};

thirdJasoInfo CLASSNAME::HLastSnd[32] = {
	/* 0 */ { "\0",   0,   0,   0 ,  S_NONE}, 
	/* 1 */ { "\0",   0,   0,   0 ,  S_NONE}, 
	/* 2 */ { "ㄱ",   2,   2,   2,  S_NONE }, 
	/* 3 */ { "ㄲ",   3,   3,   3,  S_NONE | S_DOUBLE}, 
	/* 4 */ { "ㄳ",   4,   4,   4,  S_NONE | S_COMBO}, 
	/* 5 */ { "ㄴ",   5,   5,   5,  S_NONE | S_VOICE |S_JOSA |S_EOMI}, 
	/* 6 */ { "ㄵ",   6,   6,   6,  S_NONE | S_COMBO}, 
	/* 7 */ { "ㄶ",   7,   7,   7,  S_NONE | S_COMBO}, 
	/* 8 */ { "ㄷ",   8,   8,   8,  S_NONE }, 
	/* 9 */ { "ㄹ",   9,   9,   9,  S_NONE | S_VOICE | S_JOSA|S_EOMI}, 
	/* 10 */ { "ㄺ",  10,  10,  10,  S_NONE | S_COMBO}, 
	/* 11 */ { "ㄻ",  11,  11,  11,  S_NONE | S_COMBO}, 
	/* 12 */ { "ㄼ",  12,  12,  12,  S_NONE | S_COMBO}, 
	/* 13 */ { "ㄽ",  13,  13,  13,  S_NONE | S_COMBO}, 
	/* 14 */ { "ㄾ",  14,  14,  14,  S_NONE | S_COMBO}, 
	/* 15 */ { "ㄿ",  15,  15,  15,  S_NONE | S_COMBO}, 
	/* 16 */ { "ㅀ",  16,  16,  16,  S_NONE | S_COMBO}, 
	/* 17 */ { "ㅁ",  17,  17,  17,  S_NONE| S_VOICE|S_EOMI }, 
	/* 18 */ { "\0",   0,   0,   0 ,  S_NONE}, 
	/* 19 */ { "ㅂ",  19,  19,  19,  S_NONE |S_EOMI}, 
	/* 20 */ { "ㅄ",  20,  20,  20,  S_NONE | S_COMBO}, 
	/* 21 */ { "ㅅ",  21,  21,  21,  S_NONE }, 
	/* 22 */ { "ㅆ",  22,  22,  22,  S_NONE | S_DOUBLE}, 
	/* 23 */ { "ㅇ",  23,  23,  23,  S_NONE | S_VOICE}, 
	/* 24 */ { "ㅈ",  24,  24,  24,  S_NONE }, 
	/* 25 */ { "ㅊ",  25,  25,  25,  S_NONE | S_HARSH}, 
	/* 26 */ { "ㅋ",  26,  26,  26,  S_NONE | S_HARSH}, 
	/* 27 */ { "ㅌ",  27,  27,  27,  S_NONE | S_HARSH}, 
	/* 28 */ { "ㅍ",  28,  28,  28,  S_NONE | S_HARSH}, 
	/* 29 */ { "ㅎ",  29,  29,  29,  S_NONE }, 
	/* 30 */ { "\0",   0,   0,   0 ,  S_NONE}, 
	/* 31 */ { "\0",   0,   0,   0 ,  S_NONE}
};

/**
완성형 자모 코드만 출력한것. 자소로 분리.
초성에 올수 없는 자모는  초성 값이 1.
중성에 올수 없는 자모는  중성 값이 2.
종성에 올수 있는 이중 자모만  종성 값이 있고, 나머지는 값이 1

A4A1 ㄱ ㄱ         2  2  1 0 00000000
A4A2 ㄲ ㄲ         3  2  1 0 00000000
A4A3 ㄳ       ㄳ   1  2  4 0 00000000
A4A4 ㄴ ㄴ         4  2  1 0 00000004
A4A5 ㄵ       ㄵ   1  2  6 0 00000000
A4A6 ㄶ       ㄶ   1  2  7 0 00000000
A4A7 ㄷ ㄷ         5  2  1 0 00000000
A4A8 ㄸ ㄸ         6  2  1 0 00000000
A4A9 ㄹ ㄹ         7  2  1 0 00000004
A4AA ㄺ       ㄺ   1  2 10 0 00000000
A4AB ㄻ       ㄻ   1  2 11 0 00000000
A4AC ㄼ       ㄼ   1  2 12 0 00000000
A4AD ㄽ       ㄽ   1  2 13 0 00000000
A4AE ㄾ       ㄾ   1  2 14 0 00000000
A4AF ㄿ       ㄿ   1  2 15 0 00000000
A4B0 ㅀ       ㅀ   1  2 16 0 00000000
A4B1 ㅁ ㅁ         8  2  1 0 00000004
A4B2 ㅂ ㅂ         9  2  1 0 00000004
A4B3 ㅃ ㅃ        10  2  1 0 00000000
A4B4 ㅄ       ㅄ   1  2 20 0 00000000
A4B5 ㅅ ㅅ        11  2  1 0 00000000
A4B6 ㅆ ㅆ        12  2  1 0 00000000
A4B7 ㅇ ㅇ        13  2  1 0 00000000
A4B8 ㅈ ㅈ        14  2  1 0 00000000
A4B9 ㅉ ㅉ        15  2  1 0 00000000
A4BA ㅊ ㅊ        16  2  1 0 00000000
A4BB ㅋ ㅋ        17  2  1 0 00000000
A4BC ㅌ ㅌ        18  2  1 0 00000000
A4BD ㅍ ㅍ        19  2  1 0 00000000
A4BE ㅎ ㅎ        20  2  1 0 00000000
A4BF ㅏ    ㅏ      1  3  1 0 00000000
A4C0 ㅐ    ㅐ      1  4  1 0 00000000
A4C1 ㅑ    ㅑ      1  5  1 0 00000000
A4C2 ㅒ    ㅒ      1  6  1 0 00000000
A4C3 ㅓ    ㅓ      1  7  1 0 00000000
A4C4 ㅔ    ㅔ      1 10  1 0 00000000
A4C5 ㅕ    ㅕ      1 11  1 0 00000000
A4C6 ㅖ    ㅖ      1 12  1 0 00000000
A4C7 ㅗ    ㅗ      1 13  1 0 00000000
A4C8 ㅘ    ㅘ      1 14  1 0 00000000
A4C9 ㅙ    ㅙ      1 15  1 0 00000000
A4CA ㅚ    ㅚ      1 18  1 0 00000000
A4CB ㅛ    ㅛ      1 19  1 0 00000000
A4CC ㅜ    ㅜ      1 20  1 0 00000000
A4CD ㅝ    ㅝ      1 21  1 0 00000000
A4CE ㅞ    ㅞ      1 22  1 0 00000000
A4CF ㅟ    ㅟ      1 23  1 0 00000000
A4D0 ㅠ    ㅠ      1 26  1 0 00000000
A4D1 ㅡ    ㅡ      1 27  1 0 00000000
A4D2 ㅢ    ㅢ      1 28  1 0 00000000
A4D3 ㅣ    ㅣ      1 29  1 0 00000000
*/

uint2 CLASSNAME::Ws2JhTab_Jamo[NUM_WS_JAMO] = {
...
/**
완성형 한글 코드에 mapping 되는 조합형 한글 코드 테이블.

Ws2JhTab 의 index 로 완성형 한글 코드 값을 넣고,
결과 값이 조합형 코드가 된다.

Ws2JhTab_Jamo 는 완성형 자모 코드 (0xA4A1 ~ 0xA4D3) 들의
조합형 변환 테이블 이다.

테이블 구축 방법

1. linux의 iconv 도구를 활용하여 할 수 있다. -- HanCodeHelp.txt 참조.
2. http://kldp.net/docman/view.php/86/52/file52.html 에서 구한 것인가 ?
*/

uint2 CLASSNAME::Ws2JhTab[NUM_WS_UMJUL] = {
