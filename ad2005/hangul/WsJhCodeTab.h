#ifndef WS_JH_CODE_TAB_H
#define WS_JH_CODE_TAB_H
/**
chosung, jungsung, lastsnd 은 조합형 자소를 출력하기 좋게 alphabet 로 mapping  한 것.
KLDP 에서 구한 것임.
*/
char Wansung::FstSndEng[32][3]={
	"","", "g","kk","n","d","tt","r","m","b","pp","s","ss",
	"","j","jj","ch","k","t","p","h"
	,"","","","","","","","","","",""};

char Wansung::MidSndEng[32][4]={
	"","","","a","ae","ya","yae","eo",
	"","","e","yeo","ye","o","wa","wae",
	"","","oe","yo","u","woe","we","wi",
	"","","you","eu","ui","i","",""};

char Wansung::LastSndEng[32][3]={
	"","","g","kk","k","n","n","n","t","l",
...
/**
HanFirstSound, HanMiddleSound, HanLastSound 은 조합형 자소의 초성, 중성, 종성 값에 
mapping 되는 완성형 자모 글자.
*/

char Wansung::HanFirstSound[32][3]= {
	"", "", "ㄱ", "ㄲ", "ㄴ", "ㄷ", "ㄸ", "ㄹ", "ㅁ", 
	"ㅂ", "ㅃ", "ㅅ", "ㅆ", "", "ㅈ", "ㅉ", "ㅊ", "ㅋ", "ㅌ", "ㅍ", "ㅎ",
	"","","","","","","","","","",""};

char Wansung::HanMiddleSound[32][3]= {
	"","","", "ㅏ", "ㅐ", "ㅑ", "ㅒ", "ㅓ", 
	"", "", "ㅔ", "ㅕ", "ㅖ", "ㅗ", "ㅘ", "ㅙ", 
	"", "", "ㅚ", "ㅛ","ㅜ", "ㅝ", "ㅞ", "ㅟ", 
	"", "", "ㅠ", "ㅡ", "ㅢ", "ㅣ",
...
char Wansung::HanLastSound[32][3]= {
	"", "", "ㄱ", "ㄲ", "ㄳ", "ㄴ", "ㄵ", "ㄶ", "ㄷ", "ㄹ", 
	"ㄺ", "ㄻ", "ㄼ", "ㄽ", "ㄾ", "ㄿ", "ㅀ",
	"ㅁ", "", "ㅂ", "ㅄ", "ㅅ", "ㅆ", "ㅇ", "ㅈ", "ㅊ",
	"ㅋ", "ㅌ", "ㅍ", "ㅎ", "", ""
...
mapping 되는 완성형 자모 글자.
*/
firstJasoInfo Wansung::Chosung[32] = {
...
secondJasoInfo Wansung::Midsung[32] = {
	/*
...
thirdJasoInfo Wansung::Jongsung[32] = {
	/* 0 */ { "\0",   0,   0,   0 ,  S_NONE}, 
	/* 1 */ { "\0",   0,   0,   0 ,  S_NONE}, 
	/* 2 */ { "ㄱ",   2,   2,   2,  S_NONE }, 
...
uint2 Wansung::Ws2JhTab_Jamo[NUM_WS_JAMO] = {
...
uint2 Wansung::Ws2JhTab[NUM_WS_UMJUL] = {
