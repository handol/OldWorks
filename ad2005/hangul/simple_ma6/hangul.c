...
static unsigned char johab_lcon_to_wan[] =
{
	0,
							  /* (채움), ㄱ, ㄲ, ㄱㅅ, ㄴ */
	0xd4, 0xa1, 0xa2, 0xa3, 0xa4,
							  /* ㄴㅈ, ㄴㅎ, ㄷ, ㄹ, ㄹㄱ */
	0xa5, 0xa6, 0xa7, 0xa9, 0xaa,
							  /* ㄹㅁ, ㄹㅂ, ㄹㅅ, ㄹㅌ, ㄹㅍ */
	0xab, 0xac, 0xad, 0xae, 0xaf,
							  /* ㄹㅎ, ㅁ, 0, ㅂ, ㅂㅅ */
	0xb0, 0xb1, 0,    0xb2, 0xb4,
							  /* ㅅ, ㅆ, ㅇ, ㅈ, ㅊ */
...
*/
int convert_3_to_ks(unsigned int f, unsigned int m, unsigned int l, unsigned char * des)
{
	unsigned char key[3];
